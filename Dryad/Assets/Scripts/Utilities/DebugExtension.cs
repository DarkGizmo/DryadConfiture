...
public static class DebugExtension
{
	...
	/// </param>
	public static void DebugPoint(Vector3 position, Color color, float scale, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not this point should be faded when behind other objects.
	/// </param>
	public static void DebugPoint(Vector3 position, float scale, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not the bounds should be faded when behind other objects.
	/// </param>
	public static void DebugBounds(Bounds bounds, float duration, bool depthTest)
	{
	...
	/// </param>
	public static void DebugLocalCube(Transform transform, Vector3 size, Color color, Vector3 center, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not the cube should be faded when behind other objects.
	/// </param>
	public static void DebugLocalCube(Transform transform, Vector3 size, Vector3 center, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not the cube should be faded when behind other objects.
	/// </param>
	public static void DebugLocalCube(Matrix4x4 space, Vector3 size, Color color, Vector3 center, float duration, bool depthTest)
	{	
		color = (color == default(Color)) ? Color.white : color;
	...
	/// 	- Whether or not the cube should be faded when behind other objects.
	/// </param>
	public static void DebugLocalCube(Matrix4x4 space, Vector3 size, Vector3 center, float duration, bool depthTest)
	{
	...
	/// </param>
	public static void DebugCircle(Vector3 position, Vector3 up, Color color, float radius, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not the circle should be faded when behind other objects.
	/// </param>
	public static void DebugCircle(Vector3 position, Color color, float radius, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not the circle should be faded when behind other objects.
	/// </param>
	public static void DebugCircle(Vector3 position, Vector3 up, float radius, float duration, bool depthTest)
	{
    ...
    {
        DebugCircle(position, radius, 0.0f);
    }

    public static void DebugCircle(Vector3 position, float radius, float duration)
    {
        DebugCircle(position, radius, duration, false);
    }

	public static void DebugCircle(Vector3 position, float radius, float duration, bool depthTest)
	{
    ...
    {
        DebugWireSphere(position, color, radius, 0);
    }

    public static void DebugWireSphere(Vector3 position, Color color, float radius, float duration)
    {
        DebugWireSphere(position, color, radius, duration, false);
    }

	public static void DebugWireSphere(Vector3 position, Color color, float radius, float duration, bool depthTest)
	{
		float angle = 10.0f;
	...
	/// 	- Whether or not the sphere should be faded when behind other objects.
	/// </param>
	public static void DebugWireSphere(Vector3 position, float radius, float duration, bool depthTest)
	{
	...
	/// </param>
	public static void DebugCylinder(Vector3 start, Vector3 end, Color color, float radius, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not the cylinder should be faded when behind other objects.
	/// </param>
	public static void DebugCylinder(Vector3 start, Vector3 end, float radius, float duration, bool depthTest)
	{
	...
	/// </param>
	public static void DebugCone(Vector3 position, Vector3 direction, Color color, float angle, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not the cone should be faded when behind other objects.
	/// </param>
	public static void DebugCone(Vector3 position, Vector3 direction, float angle, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not the cone should be faded when behind other objects.
	/// </param>
	public static void DebugCone(Vector3 position, Color color, float angle, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not the cone should be faded when behind other objects.
	/// </param>
	public static void DebugCone(Vector3 position, float angle, float duration, bool depthTest)
	{
	...
	/// </param>
	public static void DebugArrow(Vector3 position, Vector3 direction, Color color, float duration, bool depthTest)
	{
	...
	/// 	- Whether or not the arrow should be faded when behind other objects. 
	/// </param>
	public static void DebugArrow(Vector3 position, Vector3 direction, float duration, bool depthTest)
	{
	...
	/// </param>
	public static void DebugCapsule(Vector3 start, Vector3 end, Color color, float radius, float duration, bool depthTest)
	{
		Vector3 up = (end-start).normalized*radius;
		Vector3 forward = Vector3.Slerp(up, -up, 0.5f);
		Vector3 right = Vector3.Cross(up, forward).normalized*radius;
	...
	/// 	- Whether or not the capsule should be faded when behind other objects.
	/// </param>
	public static void DebugCapsule(Vector3 start, Vector3 end, float radius, float duration, bool depthTest)
	{
	...
	/// </param>
	public static void DrawPoint(Vector3 position, Color color, float scale)
	{
	...
	/// </param>
	public static void DrawLocalCube(Transform transform, Vector3 size, Color color, Vector3 center)
	{
		Color oldColor = Gizmos.color;
		Gizmos.color = color;
	...
	///		- The local position of the cube.
	/// </param>	
	public static void DrawLocalCube(Transform transform, Vector3 size, Vector3 center)
	{
	...
	/// 	- The color of the cube.
	/// </param>
	public static void DrawLocalCube(Matrix4x4 space, Vector3 size, Color color, Vector3 center)
	{
		Color oldColor = Gizmos.color;
		Gizmos.color = color;
	...
	/// 	- The local position of the cube.
	/// </param>
	public static void DrawLocalCube(Matrix4x4 space, Vector3 size, Vector3 center)
	{
	...
	/// 	- The radius of the cylinder.
	/// </param>
	public static void DrawCylinder(Vector3 start, Vector3 end, Color color, float radius){
		Vector3 up = (end-start).normalized*radius;
		Vector3 forward = Vector3.Slerp(up, -up, 0.5f);
		Vector3 right = Vector3.Cross(up, forward).normalized*radius;
	...
	/// 	- The angle of the cone.
	/// </param>
	public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle)
	{
		float length = direction.magnitude;
	...
	/// 	- The radius of the capsule.
	/// </param>
	public static void DrawCapsule(Vector3 start, Vector3 end, Color color, float radius)
	{
		Vector3 up = (end-start).normalized*radius;
		Vector3 forward = Vector3.Slerp(up, -up, 0.5f);
		Vector3 right = Vector3.Cross(up, forward).normalized*radius;
	...
	/// </param>
	public static string MethodsOfObject(System.Object obj, bool includeInfo)
    {
		string methods = "";
	...
	/// 	- Whether or not to include each method's method info in the list.
	/// </param>
	public static string MethodsOfType(System.Type type, bool includeInfo)
    {
		string methods = "";
